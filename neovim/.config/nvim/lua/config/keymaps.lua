...
vim.keymap.set("n", "<M-+>", ":resize +10<CR>", opts)
vim.keymap.set("n", "<M-->", ":resize -10<CR>", opts)
vim.keymap.set("n", "<M-char-62>", ":vertical resize +50<CR>", opts)
vim.keymap.set("n", "<M-lt>", ":vertical resize -50<CR>", opts)
...
vim.keymap.set({ "n", "v" }, "<Leader><Leader>y", '"*y', opts)
